package EbrcWebsiteCommon::View::GraphPackage::GGScatterPlot;
...
package EbrcWebsiteCommon::View::GraphPackage::GGScatterPlot::LogRatio;
use base qw( EbrcWebsiteCommon::View::GraphPackage::GGScatterPlot );
use strict;
...
package EbrcWebsiteCommon::View::GraphPackage::GGScatterPlot::ClinicalMetaData;
use base qw( EbrcWebsiteCommon::View::GraphPackage::GGScatterPlot );
use strict;
