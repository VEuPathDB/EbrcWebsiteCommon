package EbrcWebsiteCommon::View::GraphPackage::LegacyGGPiePlot;
...
# package EbrcWebsiteCommon::View::GraphPackage::LegacyGGPiePlot::MPMP;
# use base qw( EbrcWebsiteCommon::View::GraphPackage::LegacyGGPiePlot );
# use strict;
