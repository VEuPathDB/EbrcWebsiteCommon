...
const siteAnnouncements = [
...

  {
    ...
    if ( (props.projectId == 'ClinEpiDB' || props.projectId == 'AllClinEpiDB') && (props.location.pathname === '/') ) {
        return (
          <div>
            This site will be discontinued on April 25, 2023. Access our new and improved data exploration platform and download files at <a target="_blank" href="https://clinepidb.org">clinepidb.org</a>!
          </div>
        );
      }
      return null;
