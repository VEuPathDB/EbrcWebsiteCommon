...
public class JspConstants {
  ...
  public String getOrthoGoogleUrl() { return ORTHO_GOOGLE_URL; }
  ...
  public static final String PUBLICATION_URL =
    ...
    "TriTrypDB+AmoebaDB+MicrosporidiaDB+%22FungiDB%22+PiroplasmaDB+" +
    "ApiDB+EuPathDB&as_eq=encrypt+cryptography+hymenoptera&as_occt=any&" +
    "as_sauthors=&as_publication=&as_ylo=&as_yhi=&as_sdt=1.&as_sdtp=on&" +
    "as_sdtf=&as_sdts=39&btnG=Search+Scholar&hl=en";

  public static final String ORTHO_GOOGLE_URL =
    "http://scholar.google.com/scholar?as_q=&num=10&as_epq=&" +
    "as_oq=OrthoMCL&as_eq=encrypt+cryptography+hymenoptera&as_occt=any&" +
    "as_sauthors=&as_publication=&as_ylo=&as_yhi=&as_sdt=1.&as_sdtp=on&" +
    "as_sdtf=&as_sdts=39&btnG=Search+Scholar&hl=en";
}
