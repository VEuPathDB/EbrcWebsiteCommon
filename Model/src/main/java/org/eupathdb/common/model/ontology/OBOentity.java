...
public class OBOentity {
  ...
  public static ArrayList<String> getStringArrayAnnotProps(OWLEntity cls, OWLOntology ont,
      OWLAnnotationProperty annotProp) {
  ...
  public static String getStringAnnotProps(OWLEntity cls, OWLOntology ont,
      OWLAnnotationProperty annotProp) {
    String propStr = "";
  ...
  public static ArrayList<IRI> getIRIAnnotProps(OWLEntity cls, OWLOntology ont,
      OWLAnnotationProperty annotProp) {
  ...
  public static boolean isObsolete(OWLEntity cls, OWLOntology ont, OWLDataFactory df) {
    ...
    OWLAnnotationProperty deprecateProp = df.getOWLAnnotationProperty(
        IRI.create(Config.Deprecated_AnnotPorp));
