package EbrcWebsiteCommon::Model::CannedQuery::SenseAntisenseX;
...
from ( select 
        ...
        , round(log(2,greatest(comp.value,<<AntisenseFloor>>) / greatest(ref.value,<<AntisenseFloor>>)),1) as CONTXAXIS
        from comp, ref
