...
<li>If you see a <span style="color:red">red X</span> or a step showing 0 results, please click on its name and choose 'Revise'. Re-run the step after adjusting parameters as needed.
...
<ul class="cirbulletlist">
<li>Open the <a href="<c:url value="/help.jsp"/>" target="_blank" onClick="poptastic(this.href); return false;">Contact Us</a> form,
