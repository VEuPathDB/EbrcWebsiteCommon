...
use lib\modules\ {CommentConfig, ModelConfig, WdkProperties};
...
<?php } else { ?>
  ...
  <div class="expandable" style="padding: 5px;">
    ...
    <p>
      ...
      showAddComment.do action) - not at webapp load time. Passwords have been masked in this display.<br>
      <i>This information is </i><b>not</b><i> suitable for copying directly into the comment-config.xml as the
        attribute names shown here may not match the RNG spec.</i>
    </p>
    <pre>
<?php
ksort($comment);
